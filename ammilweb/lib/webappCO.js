...
(() => {
    ...
    class WebApp  extends HDivision{
        constructor() {
            ...
            this.navClients = new NavButton('navClient','Clients',accIcon);
            this.navPF = new NavButton('navPF','Portfolio',accIcon);
            this.navApp = new NavButton('navApp','Applications',loanIcon);

            this.navBar.addComponent([
                this.navClients,this.navPF,this.navApp
            ])
            ...
            this.btnCreateAccount = new GenButtonRounded("btnCreateAccount","Create an Account", 110,ECS.getDanger(),ECS.getDangerDark()).addCustomStyle([
                Position(),
                Float("left"),
                Margin(10,'px').setTop(40)
            ])
            ...
            this.buttonsBar.addComponent([
                this.btnApplyLoan,this.btnApplyContract,this.btnCreateAccount
            ])
            */
