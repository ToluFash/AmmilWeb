...
(() => {
    ...
    class WebApp  extends HDivision{
        constructor() {
            ...
            this.navAccounts = new NavButton('navAccounts','Accounts',accIcon);
            this.navApplications = new NavButton('navApplications','Applications',accIcon);
            this.navLoans = new NavButton('navLoans','Loans',loanIcon);

            this.navBar.addComponent([
                this.navAccounts,
                this.navApplications,
                this.navLoans,
            ])
